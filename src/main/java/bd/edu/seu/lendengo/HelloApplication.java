...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        this.stage = stage;
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/bd/edu/seu/lendengo/fxml/pos.fxml"));
        Scene scene = new Scene(fxmlLoader.load(), 1515, 800);
        scene.getStylesheets().add(getClass().getResource("/bd/edu/seu/lendengo/stylesheets/POS.css").toExternalForm());
