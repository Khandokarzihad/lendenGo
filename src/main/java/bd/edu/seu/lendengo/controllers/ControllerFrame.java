...
//        }
    ...
    public void userEvent(MouseEvent event) {
        ...
        if(userVbox.isVisible()){
            ...
            shrinkAll();
            dashboardService.expandVBox(userVbox,110,angle13);
        }
    }
    ...
    @FXML
    public void reportsPanEnterEvent(MouseEvent event) {
        reportsPane.setVisible(true);
        reportsPane.toFront();
    }

    @FXML
    public void reportsPaneExitEvent(MouseEvent event) {
        reportsPane.setVisible(false);
        reportsPane.toBack();
    }

    @FXML
    public void logOutEvent(MouseEvent event) {
    ...
    public void addCustomerEvent(MouseEvent event) {
        ...
        HelloApplication helloApplication = new HelloApplication();
        helloApplication.changeScene("customer", "User");
    }
    ...
    public void customerListEvent(MouseEvent event) {
        ...
        HelloApplication helloApplication = new HelloApplication();
        helloApplication.changeScene("customerList", "User");
    }
